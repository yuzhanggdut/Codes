package date2num;
	...
	public class DateConvertor {
	  ...
	  public static void main(String[] args) {
	        ...
	        String issueDate = "2001-2-5";
	        //System.out.println(getYearStr(formatStr(issueDate)));
	        System.out.println("数字日期："+issueDate);
	        System.out.println("汉字日期："+formatStr(issueDate));
	    }
	  ...
	  */
	  ...
	  return dayStr;
	    ...
	    public static String formatStr(String str){
	        ...
	        for(int i = 0; i < 4; i++){
	            sb.append(formatDigit(str.charAt(i)));//取单个字符转换并拼接
	        }
	        sb.append('年');
	        System.out.println("年份："+sb);
